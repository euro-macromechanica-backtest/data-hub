<h1 align="center">📅 Экономические календари для бэктеста EUR/USD</h1>
...
Смотреть в **[папке integrity](https://github.com/euro-macromechanica-backtest/data-hub/tree/main/integrity/economic_calendars)**:
...
- Решение по ставке SNB; пресс‑конференции; внеплановые события
...
Целостность обеспечивается через **SHA‑256** хеши финальных файлов, **GPG‑подписи**, а также **OTS‑якорение** архива всех CSV с 2001 по конец июля 2025. В совокупности это гарантирует, что календарь **не** был подогнан под результаты бэктестов.
