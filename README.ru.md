...
- Все минутные данные (RAW) и текстовые отчёты по разрывам **EUR/USD (январь 2001 — август 2025) и GBP/USD (январь 2008 - август 2025)** в `source_data/raw/**` сопровождаются roll-up-манифестами `.sha256`, **GPG-подписью** и **OpenTimestamps (OTS)** — это фиксирует момент получения данных.  
